...
class Dragon_Whelp(Monster):

    # region constructeur

    def __init__(self):
        super().__init__()
        self.__name = "dragonnet"
        self.__id = 3
    ...
    def chara_stat(self):
        list_of_grade = ["Fureur ","Petit ","Grand ","Monstrueux ","Mère "]
        randomizer_grade = random.randint(0,len(list_of_grade)-1)
        grade = list_of_grade[randomizer_grade]
        list_of_region = [" des montagnes"," des forêts"," des plaines"," de givre", " des volcans"]
